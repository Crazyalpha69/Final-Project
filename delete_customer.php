...
$sqlca="SELECT * FROM loan_application where c_id = '$id'";
$resultca= mysqli_query($db, $sqlca);
$cca = mysqli_num_rows($resultca);
 ...
 if(id && mobile && address)
  {
    ...
    ({
      ...
      {
      document.getElementById("status").innerHTML="<div id='successMessage' class='alert alert-success alert-dismissible'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Deleted Successfully ✓</div>";;
  document.getElementById("status1").innerHTML="<div id='successMessage' class='alert alert-success alert-dismissible'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Deleted Successfully ✓</div>";;

    document.getElementById("form").className = "hidee";
  ...
  return false;
        ...
        <h3 class="page-heading mb-4">Delete Customer</h3>
...
<form action="" id="form" class="aa" method="post" enctype="multipart/form-data" onsubmit="return chk();" />
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <img style="width:80px;height:100px;" id="img" class="aa" src="customers/<?php echo $img; ?>" alt="" >
                </div>
            </div>
         ...
         <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="number" name="address" id="balance" value="<?php echo $balance; ?>" class="form-control" readonly>
                </div>
            </div>
          ...
          <div class="form-group row">
              <div class="col-md-6">
              <button class="btn btn-info pull-right" id="submit" name="submit">Delete</button>
              </div>
          </div>  
        </form>
