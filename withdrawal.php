 ...
 if(deposit && id)
  {
    ...
    ({
      ...
      {
      document.getElementById("status").innerHTML="<div id='successMessage' class='alert alert-success alert-dismissible'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>withdrawn Successfully ✓</div>";;
  document.getElementById("status1").innerHTML="<div id='successMessage' class='alert alert-success alert-dismissible'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>withdrawn Successfully ✓</div>";;
  ...
  return false;
        ...
        <h3 class="page-heading mb-4">Withdraw</h3>
...
<form action="" method="post" enctype="multipart/form-data" onsubmit="return chk();" />
         ...
         <div class="form-group row">
          ...
          <hr>
            ...
            <div class="form-group row">
                <label  class="text-right col-2 font-weight-bold col-form-label">withdrawal Amount (Birr)</label>                      
                 <div class="col-sm-9">
                  <input type="number" name="deposit"  id="deposit" class="form-control"  placeholder="Enter withdrawal Amount" required>
              </div>
            </div> 
