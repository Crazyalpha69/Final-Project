...
{
$sql="update loan_application set status = 'Disproved' WHERE c_id = $loan_id";
  mysqli_query($db, $sql);
...
?>
 ...
 <h3 class="page-heading mb-4">Loan Disprove page</h3>
          <div class="row mb-2">
             ...
             <div class="col-md-6 mb-4">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Disprove loan</h5>
					...
					<form  action="" class="form" method="POST" >
					    ...
					    <hr>
					    <div class="for-group">
					    	<input type="submit" name="submit" class="btn btn-primary btn-sm" value="Disprove">
					    </div>
