...
<div class="card">
  ...
  <div class="card-body">
      ...
      <tbody>
	            ...
	            <tr>
	        <?php
              $sqli="SELECT * FROM loan_application where status = 'Pending'";
              ...
              while ($row = mysqli_fetch_array($resulti))
              {
                ...
                echo '<td><a href="individual_verify.php?loan_id='.$c_id.'" class="btn btn-outline-success btn-sm">Verify Loan</a>
                <a href="individual_disprove.php?loan_id='.$c_id.'" class="btn btn-outline-success btn-sm">Disprove</a></td>';
                echo '</tr>';
              }
            ?>
